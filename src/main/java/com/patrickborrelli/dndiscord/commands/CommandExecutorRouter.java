...
/**
 * Command Factory singleton that handles all message routing from listeners to
 * command executors.
 * 
...
public class CommandExecutorRouter {
	...
	private void initMap() {
		...
		map.put(CommandUtil.SHEET, new SheetCommand());
	}

	/**
	 * Retrieve the appropriate CommandExecutor instance for the provided message
	 * type.
	 * 
