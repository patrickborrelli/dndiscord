...
public enum ActivationType {
	ACTION(1), NO_ACTION(2), BONUS_ACTION(3), REACTION(4), MINUTE(6), HOUR(7), SPECIAL(8);
	...
	static {
		valuesMap = new HashMap<Integer, ActivationType>(ActivationType.values().length);
		...
		stringMap = new HashMap<ActivationType, String>(ActivationType.values().length);
		...
		inverseMap = new HashMap<String, ActivationType>(ActivationType.values().length);
	 ...
	 * @return an ActivationType containing the enumeration represented by the
	 *         provided String.
	 */
