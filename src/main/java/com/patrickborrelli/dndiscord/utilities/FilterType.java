...
public enum FilterType {
	...
	ARMOR("Armor"), POTION("Potion"), RING("Ring"), ROD("Rod"), SCROLL("Scroll"), STAFF("Staff"), WAND("Wand"),
	WEAPON("Weapon"), WONDROUS("Wondrous"), OTHER_GEAR("Other gear");

	private String value;
	private static HashMap<String, FilterType> valuesMap;

	static {
		valuesMap = new HashMap<String, FilterType>(FilterType.values().length);
