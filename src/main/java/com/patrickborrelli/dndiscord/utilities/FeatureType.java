...
public enum FeatureType {
	...
	CLASS_FEATURE("Class"), CLASS_OPTION("Option"), RACE("Race"), SUBCLASS("Subclass"), BACKGROUND("Background"),
	ITEM("Item"), FEAT("Feat");
	...
	static {
		valuesMap = new HashMap<String, FeatureType>(FeatureType.values().length);
