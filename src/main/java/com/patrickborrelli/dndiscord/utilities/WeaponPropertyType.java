...
public enum WeaponPropertyType {
	...
	static {
		valuesMap = 
			new HashMap<Integer, WeaponPropertyType>(WeaponPropertyType.values().length);
		...
		stringMap = 
			new HashMap<WeaponPropertyType, String>(WeaponPropertyType.values().length);
	 ...
	 * @return an WeaponPropertyType containing the enumeration 
