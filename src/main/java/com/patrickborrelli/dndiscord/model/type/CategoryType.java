...
public enum CategoryType {
	...
	static {
		valuesMap = new HashMap<Integer, CategoryType>(CategoryType.values().length);
		valuesMap.put(1, SIMPLE);
		valuesMap.put(2, MARTIAL);

		stringMap = new HashMap<CategoryType, String>(CategoryType.values().length);
	 ...
	 * @return an CategoryType containing the enumeration represented by the
	 *         provided String.
	 */
