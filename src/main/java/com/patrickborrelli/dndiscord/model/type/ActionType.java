...
public enum ActionType {
	...
	static {
		valuesMap = 
			new HashMap<Integer, ActionType>(ActionType.values().length);
		valuesMap.put(1, WEAPON);
		valuesMap.put(2, SPELL);
		valuesMap.put(3, GENERAL);
		
		stringMap = 
			new HashMap<ActionType, String>(ActionType.values().length);
	 ...
	 * @return an ActionType containing the enumeration 
